...
public class AdapterHienThiNhanVien extends BaseAdapter {
    ...
    public class ViewHolderNhanVien {
        ...
        TextView txtTenNhanVien, txtCMNDNhanVien;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolderNhanVien.txtCMNDNhanVien = (TextView) view.findViewById(R.id.txtCMND);
        ...
        viewHolderNhanVien.txtCMNDNhanVien.setText(String.valueOf(nhanVienDTO.getCMND()));
        return view;
    }
}
