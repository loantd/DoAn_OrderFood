...
public class GoiMonDAO {
    ...
    public long LayMaGoiMonTheoBan(int maban,String tinhtrang){
        String sTruyvan=" SELECT * FROM " +CreateDatabase.TB_GOIMON + " WHERE " + CreateDatabase.TB_GOIMON_MABAN + " = '" + maban + "' AND "
    ...
    public boolean KiemTraMonTonTai(int magoimon,int mamonan){
        String struyVan=" SELECT * FROM " + CreateDatabase.TB_CHITIETGOIMON + " WHERE " + CreateDatabase.TB_CHITIETGOIMON_MAMONAN
    ...
    public boolean CapNhatSL(ChiTietGoiMonDTO chiTietGoiMonDTO){
        ...
        long kiemtra=database.update(CreateDatabase.TB_CHITIETGOIMON,contentValues,CreateDatabase.TB_CHITIETGOIMON_MAGOIMON + " = " + chiTietGoiMonDTO.getMaGoiMon() + " AND " + CreateDatabase.TB_CHITIETGOIMON_MAMONAN + " = " + chiTietGoiMonDTO.getMaMonAn(),null);
    ...
    public List<ThanhToanDTO> LayDanhSachMonAnTheoMaGoiMon(int magoimon){
        String struyVan="SELECT *FROM " + CreateDatabase.TB_CHITIETGOIMON + " ct, " + CreateDatabase.TB_MONAN + " ma WHERE "
